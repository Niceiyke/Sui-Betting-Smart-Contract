...
const Navbar = () => {
  ...
  const navLinks = [
    { path: "/", label: "Home" },
    { path: "/create", label: "New Event" },
    { path: "/active", label: "Update Result" },
    { path: "/resolved", label: "Claim Winning" },
  ];
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <ConnectButton className="hover:bg-blue-700 px-3 py-2 rounded-md text-sm font-medium" />
            </div>
          </div>
          {/* Mobile Menu Button */}
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="hover:bg-blue-700 block px-3 py-2 rounded-md text-base font-medium">
              <ConnectButton />
            </div>
          </div>
        </div>
